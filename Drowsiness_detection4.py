...
def ret_des(frame):
    ...
    rects = face_recognition.face_locations(gray)  # 人脸检测
...
def drowsinessDetection(cap):
    global alarm, frame_counter, mouth_alarm, mouth_frame_counter, head_alarm, head_frame_counter, pose_alarm, pose_frame_counter
